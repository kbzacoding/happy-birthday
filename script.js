...
// === Activar audio por defecto (modificado) ===
try {
...
} catch(e) { console.warn('No se pudo activar audio automáticamente', e); }
...
MASTER_TL.add(() => { try { SOUNDS.TUNE.play().catch(()=>{}); } catch(e){} }, 'LIGHTS_OUT');
